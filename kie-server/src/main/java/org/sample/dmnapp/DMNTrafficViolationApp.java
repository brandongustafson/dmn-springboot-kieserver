...
public class DMNTrafficViolationApp {

	private static final String GROUP_ID = "com.violation";
	private static final String ARTIFACT_ID = "traffic-violation-kjar";
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(DMNTrafficViolationApp.class, args);
	}
